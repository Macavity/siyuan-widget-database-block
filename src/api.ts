...
export async function request(url: string, data: unknown) {
...
export async function setStorageVal(key: string, val: unknown) {
  const data = {
...
export async function getLocalStorage(): Promise<{ [key: string]: unknown }> {
